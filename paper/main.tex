...
student group runs its own project under a supervising account.
...
The \emph{platform} track continues with a more flexible task model and
live multi-evaluator observation, for which the organization layer is
the prerequisite already in place. The event timelines, raw data export,
order counterbalancing, additional questionnaires, retroactive
anonymization, auto-instrumentation, qualitative coding, Portuguese
participant client, and organizations described in Section~III were
themselves motivated by the two studies and shipped since they
concluded.

\section*{Availability}
The platform is deployed at \url{https://avalux.pt}. Its source, comprising the
application, the database schema (41 SQL migrations), the seeded protocol
