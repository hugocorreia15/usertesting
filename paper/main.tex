...
The event timelines, raw data export, order counterbalancing,
additional questionnaires, retroactive anonymization,
auto-instrumentation, qualitative coding, Portuguese participant
client, organizations, and live session observation described in
Section~III were themselves motivated by the two studies and shipped
since they concluded.

\section*{Availability}
The platform is deployed at \url{https://avalux.pt}. Its source, comprising the
application, the database schema (45 SQL migrations), the seeded protocol
